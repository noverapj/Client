...
__forceinline unsigned int return150() { __asm mov eax, 150 };
...
#define FLOAT150	((float)return150())
...
#include "LuaState/lauxlib.h"
	...
	#pragma comment(lib, "ioVoiceChatd.lib")
	#pragma comment(lib, "LuaStated.lib")
	...
	#pragma comment(lib, "gdiplus" )
		...
		#pragma comment(lib, "ioVoiceChat.lib")
		#pragma comment(lib, "LuaState.lib")
